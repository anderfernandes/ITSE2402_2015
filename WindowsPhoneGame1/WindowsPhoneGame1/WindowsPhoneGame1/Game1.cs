...
namespace WindowsPhoneGame1
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        public Game1()
        {
            ...
            // Line required to correct corruput emulator when using XNA with some emulators
            // vertical hold is off if not used with some video cards and running SDK 7.1.1 patch
        ...
        void UpdateSprite(GameTime gameTime, ref Vector2 spritePosition, ref Vector2 spriteSpeed)
        {
            ...
            int MinY = 0;
            if (spritePosition.X > MaxX) // Check for bounce
            {
                spriteSpeed.X *= -1;
        ...
        {
            // Check to see if the 2 boxes are intersecting
